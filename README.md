...
| --------- | ---------------------------------------- | -------- | ---- |
| 4032x3024 | 原始实现                                 | 100      |      |
| 4032x3024 | 第一版优化（float->INT）                 | 100      |      |
| 4032x3024 | OpenCV 自带函数                          | 100      |      |
| 4032x3024 | 第二版优化（手动4路并行）                | 100      |      |
| 4032x3024 | 第三版优化（OpenMP4线程）                | 100      |      |
| 4032x3024 | 第四版优化（SSE优化，一次处理12个像素）  | 100      |      |
| 4032x3024 | 第五版优化（SSE优化，一次处理15个像素）  | 100      |      |
| 4032x3024 | 第六版优化（AVX2优化，一次处理10个像素） | 100      |      |
| 4032x3024 | 第七版优化（AVX2优化+std::async）        | 100      |      |
