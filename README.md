...
| 分辨率    | 优化                                     | 循环次数 | 速度 |
| --------- | ---------------------------------------- | -------- | ---- |
| 4032x3024 | 原始实现                                 | 1000      |  0.264ms    |
| 4032x3024 | 第一版优化（float->INT）                 | 1000      |   0.173ms   |
| 4032x3024 | OpenCV 自带函数                          | 1000      |   0.273ms   |
| 4032x3024 | 第二版优化（手动4路并行）                | 1000      |   0.239ms   |
| 4032x3024 | 第三版优化（OpenMP4线程）                | 1000      |   0.158ms   |
| 4032x3024 | 第四版优化（SSE优化，一次处理12个像素）  | 1000      |   0.124ms   |
| 4032x3024 | 第五版优化（SSE优化，一次处理15个像素）  | 1000      |  0.112ms    |
| 4032x3024 | 第六版优化（AVX2优化，一次处理10个像素） | 1000      |   0.073ms   |
| 4032x3024 | 第七版优化（AVX2优化+std::async）        | 1000      |   0.169ms   |
