...
|优化方式|图像分辨率 |速度|
|---------|----------|-------|
|RGB2YUV C语言实现|4272*2848|45.57|
|RGB2YUV SSE初级优化|4272*2848|17.06|
|RGB2YUV SSE高级优化|4272*2848|13.52|
|YUV2RGB C语言实现|4272*2848|81.05|
|YUV2RGB SSE初级优化|4272*2848|14.95|